...
formula1dl_demo_sas_token = dbutils.secrets.get(scope = 'formula1pro2-scope', key = 'formula1dl-demo-sas-token')
...
spark.conf.set("fs.azure.sas.fixed.token.formula1dlpro2.dfs.core.windows.net", formula1dl_demo_sas_token)
