...
.option("header", True) \
.schema(races_schema) \
.csv("/mnt/formula1dlpro2/raw/races.csv")
...
races_selected_df.write.mode('overwrite').partitionBy('race_year').parquet('/mnt/formula1dlpro2/processed/races')

# COMMAND ----------

# MAGIC %fs
# MAGIC ls /mnt/formula1dlpro2/processed/races

# COMMAND ----------

display(spark.read.parquet('/mnt/formula1dlpro2/processed/races'))